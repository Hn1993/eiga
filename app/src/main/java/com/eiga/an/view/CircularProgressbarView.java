...
public class CircularProgressbarView extends View {
    ...
    private void initData(Context context, AttributeSet attrs) {
        ...
        textSize = typedArray.getDimension(R.styleable.CircularProgressbarView_textSize, 120);
        roundWidth = typedArray.getDimension(R.styleable.CircularProgressbarView_roundWidth, 10);
        textShow = typedArray.getBoolean(R.styleable.CircularProgressbarView_textShow, true);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if(percent != 0){
            ...
            canvas.drawText(str,getWidth() / 2-mStrPaint.measureText(str) / 2 ,getWidth() / 2  +(fm.bottom - fm.top)/2 - fm.bottom+60,mStrPaint);
        }
    }
